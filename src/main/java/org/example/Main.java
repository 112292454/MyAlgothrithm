...
public class Main {
	...
	public static void main(String args[]) {
		...
		out.println("arr.size() = " + arr.size());
		a=arr.toArray(new Integer[0]);
		out.println("a.length = " + a.length);
	...
	static class Node extends node{
		public Node(int a,int b){x=a;value=b;}
		@Override
		public boolean equals(Object obj) {return x==((Node)obj).x&&value==((Node)obj).value;}
	}
	...
	public static int test(int a, int b){
		...
		if(a!=1){
			int temp1=b;
			int temp2=test(a-1,b)+b;
			res=temp2+test(a-2,temp1);
		}
		return res;
	}
